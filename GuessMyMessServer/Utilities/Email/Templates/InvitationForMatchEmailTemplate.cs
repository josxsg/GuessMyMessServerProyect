...
{
    public class InvitationForMatchEmailTemplate : IEmailTemplate
    {
        public string Subject => "Guess My Mess - Código para Unirte a la Partida";
            ...
            HtmlBody = $@"
                <div style='font-family: Arial, sans-serif; text-align: center; color: #333;'>
                    <div style='max-width: 600px; margin: auto; border: 1px solid #ddd; padding: 20px; background-color: #f9f9f9; border-radius: 10px;'>
                        ...
                        <p style='font-size: 12px; color: #888;'>Si no estas interesado en unirte a la partida, puedes ignorar este correo.</p>
                    </div>
                </div>";
        }
    }
